...
export class RemoveCreatorFields1763007034818 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "document_types" DROP CONSTRAINT "FK_f7f8f69705cda5be450b48027f4"`);
        await queryRunner.query(`ALTER TABLE "organizations" DROP CONSTRAINT "FK_88a24953b7fb00e52d96fc1e2ba"`);
        await queryRunner.query(`ALTER TABLE "loans" DROP COLUMN "created_by"`);
        ...
        await queryRunner.query(`ALTER TABLE "document_types" DROP COLUMN "created_by"`);
        await queryRunner.query(`ALTER TABLE "organizations" DROP COLUMN "created_by"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "organizations" ADD "created_by" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "document_types" ADD "created_by" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "loans" ADD "created_by" uuid NOT NULL`);
