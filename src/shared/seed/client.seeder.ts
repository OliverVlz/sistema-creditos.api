...
export class ClientSeeder {
  ...
  async seed(
    ...
    if (!adminUser) {
      console.log(
        '⚠️ No se encontró un usuario administrador para crear clientes. Ejecuta primero el seeder de usuarios.',
      );
      return [];
    }
    ...
    if (!defaultOrganization) {
      console.log(
        '⚠️ No se encontró una organización para crear clientes. Ejecuta primero el seeder de organizaciones.',
      );
      return [];
    }
